...
class aboutPage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.DCLinkLabel = ctk.CTkLabel(self.DCFrame, text="https://discord.gg/tSW5kYuACN",
            font=ctk.CTkFont(size=16), cursor="hand2", text_color="#5555ff")
        ...
        self.DCLinkLabel.bind("<Button-1>", lambda e: openLink("https://discord.gg/tSW5kYuACN"))
        ...
        self.creditsLabel1 = ctk.CTkLabel(self, text="Hickensa (SapphireOS/Tool) for being the main inspiration for uchr's development of ShimmerOS, and my development of this tool.", font=ctk.CTkFont(size=16), cursor="hand2",wraplength=sf*1020)
        ...
        self.creditsLabel2 = ctk.CTkLabel(self, text="Chr for making ShimmerOS!", font=ctk.CTkFont(size=16), cursor="hand2")
