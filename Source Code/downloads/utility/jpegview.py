...
async def getURL(ssl_ctx,continuation,progressbar,completeDownload):
    try:
        proc = subprocess.Popen(["curl", "https://sourceforge.net/projects/jpegview/files/latest/download"],stdout=subprocess.PIPE, creationflags=subprocess.CREATE_NO_WINDOW)
